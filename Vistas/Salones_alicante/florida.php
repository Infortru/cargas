...
<body>
    ...
    ?>
        ...
        <tr>
            ...
            <td>
                <a href="../../nueva_carga.php?Id=<?php echo $fila["identificador"]?>&Nombre=<?php echo $fila["nombre"]?>&Salon=Vistas/Salones_alicante/florida.php" class="btn btn-primary">Nueva</a>
