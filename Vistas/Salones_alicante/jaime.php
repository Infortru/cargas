   ...
   <?php
    ...
    ?>
        ...
        <tr>
            ...
            <td>
                <a href="../../nueva_carga.php?Id=<?php echo $fila["identificador"]?>&Nombre=<?php echo $fila["nombre"]?>&Salon=Vistas/Salones_alicante/jaime.php" class="btn btn-primary">Nueva</a>
                <a href="../../lista_cargas.php?Id=<?php echo $fila["identificador"]?>&Salon=Vistas/Salones_alicante/jaime.php" class="btn btn-primary">Lista</a>
            </td>
        </tr>
